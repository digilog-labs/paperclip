...
import type { PaperclipPluginManifestV1, PluginStatus, InstallPlugin, UpdatePluginStatus, UpsertPluginConfig, PatchPluginConfig, PluginCompanySettings, PluginEntityQuery, PluginJobStatus, PluginJobRunStatus, PluginJobRunTrigger, PluginWebhookDeliveryStatus } from "@paperclipai/shared";
/**
...
export declare function pluginRegistryService(db: Db): {
    ...
    upsertCompanySettings: (pluginId: string, companyId: string, input: {
        enabled?: boolean;
    ...
    listEntities: (pluginId: string, query?: PluginEntityQuery) => Omit<import("drizzle-orm/pg-core").PgSelectBase<"plugin_entities", {
        ...
        scopeKind: import("drizzle-orm/pg-core").PgColumn<{
            ...
            dataType: "string";
            columnType: "PgText";
            data: "agent" | "company" | "project" | "issue" | "run" | "goal" | "instance" | "project_workspace";
            driverParam: string;
            notNull: true;
            hasDefault: false;
            isPrimaryKey: false;
            ...
            $type: "agent" | "company" | "project" | "issue" | "run" | "goal" | "instance" | "project_workspace";
        }>;
