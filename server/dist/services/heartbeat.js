...
import { AGENT_DEFAULT_MAX_CONCURRENT_RUNS, ISSUE_CONTINUATION_SUMMARY_DOCUMENT_KEY, MODEL_PROFILE_KEYS, } from "@paperclipai/shared";
...
export function heartbeatService(db, options = {}) {
    ...
    async function handleSuccessfulRunHandoff(run, agent) {
        ...
        const [activeExecutionPath, queuedWake, pendingInteraction, pendingApproval, explicitBlocker, openRecoveryIssue, existingWake, budgetBlock, pauseHold,] = await Promise.all([
            issue
                ? db
