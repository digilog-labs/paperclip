...
import { COMPANY_SEARCH_MAX_LIMIT, COMPANY_SEARCH_MAX_OFFSET, COMPANY_SEARCH_MAX_TOKENS, } from "@paperclipai/shared";
...
function makeCounts(results) {
    const counts = { issue: 0, agent: 0, project: 0 };
...
export function companySearchService(db) {
    return {
        search: async (companyId, query) => {
            ...
            const emptyCounts = { issue: 0, agent: 0, project: 0 };
