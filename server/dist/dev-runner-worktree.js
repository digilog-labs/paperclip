...
export function isLinkedGitWorktreeCheckout(rootDir) {
...
export function resolveWorktreeEnvFilePath(rootDir) {
    return path.resolve(rootDir, ".paperclip", ".env");
}
export function bootstrapDevRunnerWorktreeEnv(rootDir, env = process.env) {
...
//# sourceMappingURL=dev-runner-worktree.js.map